...
namespace IllustratorRenderingDescriptions.Tests
{
    public class DigitVerticalBarTests
    {
        ...
        public void Removes_TopLeft_Vertical_Bar_With_Overhang()
        {
            ...
            CollectionAssert.AreEqual(new[] { new PointF(1000, 1017), new PointF(1010, 1017), new PointF(1010, 1045), new PointF(1000, 1045) }, verticalBarPoints);
        }
        ...
        public void Removes_TopRight_Vertical_Bar_With_Overhang()
        {
            ...
            CollectionAssert.AreEqual(new[] { new PointF(1090, 1017), new PointF(1100, 1017), new PointF(1100, 1045), new PointF(1090, 1045) }, verticalBarPoints);
        }
        ...
        public void Removes_BottomRight_Vertical_Bar_With_Overhang()
        {
            ...
            CollectionAssert.AreEqual(new[] { new PointF(1090, 1055), new PointF(1100, 1055), new PointF(1100, 1083), new PointF(1090, 1083) }, verticalBarPoints);
        }
        ...
        public void Removes_BottomLeft_Vertical_Bar_With_Overhang()
        {
            ...
            CollectionAssert.AreEqual(new[] { new PointF(1000, 1055), new PointF(1010, 1055), new PointF(1010, 1083), new PointF(1000, 1083) }, verticalBarPoints);
        }
    }
}
