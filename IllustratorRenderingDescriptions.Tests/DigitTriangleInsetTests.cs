...
namespace IllustratorRenderingDescriptions.Tests
{
    public class DigitTriangleInsetTests
    {
        ...
        public void Creates_The_Left_Triangle_Inset()
        {
            ...
            var inset = new DigitTriangleInset(0.1f, 45f);

            var actualResults = inset.GetPoints(DigitTriangleInsetName.Left, digitBoundingBox);
        ...
        public void Creates_The_Right_Triangle_Inset()
        {
            ...
            var actualResults = inset.GetPoints(DigitTriangleInsetName.Right, digitBoundingBox);
